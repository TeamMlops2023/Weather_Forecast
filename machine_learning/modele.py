...
for i in range(len(predictions)):
    ...
    insert_query = "INSERT INTO weather_predictions (id, date, location, prediction, accuracy) VALUES (%s, %s, %s, %s)"
    cursor.execute(insert_query, (i + 1, date, location, prediction, accuracy))
